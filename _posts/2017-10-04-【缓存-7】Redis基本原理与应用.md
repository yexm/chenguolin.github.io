...
1. `APPEND`: [append](https://redis.io/commands/append) appends the value at the end of the string
2. `BITCOUNT`: [bitcount](https://redis.io/commands/bitcount) count the number of set bits (population counting) in a string
