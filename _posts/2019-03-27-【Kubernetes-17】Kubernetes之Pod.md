...
4. 先创建 initContainer，主要包括 拉取镜像、调用容器运行时创建容器 [CreateContainer](https://github.com/containerd/cri/blob/master/pkg/server/container_create.go#L48)、调用容器运行时启动容器 [StartContainer](https://github.com/containerd/cri/blob/master/pkg/server/container_start.go#L40)、执行 PostStart 几个步骤
5. 再创建 业务容器，主要包括 拉取镜像、调用容器运行时创建容器 [CreateContainer](https://github.com/containerd/cri/blob/master/pkg/server/container_create.go#L48)、调用容器运行时启动容器 [StartContainer](https://github.com/containerd/cri/blob/master/pkg/server/container_start.go#L40)、执行 PostStart 几个步骤
