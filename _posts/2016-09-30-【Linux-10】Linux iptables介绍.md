...
| TCP、UDP |  32768 ~ 65535 | 0.0.0.0/0   |  允许所有源端口为 32768 ~ 61000 区间IP数据包 | 
...
// 规则配置 (允许 入方向 tcp/udp:32768~65535)
$ iptables -t filter -A INPUT -p tcp --match multiport --sports 32768:65535 -j ACCEPT
$ iptables -t filter -A INPUT -p udp --match multiport --sports 32768:65535 -j ACCEPT
